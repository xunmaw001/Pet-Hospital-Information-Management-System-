          ...
          <form class="layui-form">
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 0px;">
                <input type="text" id="wenzhangbiaoti" name="wenzhangbiaoti" placeholder="请输入文章标题" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 0px;">
                <input type="text" id="wenzhangneirong" name="wenzhangneirong" placeholder="请输入文章内容" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
