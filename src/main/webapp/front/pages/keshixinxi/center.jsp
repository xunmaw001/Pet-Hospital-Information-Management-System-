							...
							<div class="layui-input-block">
								<button type="button" class="layui-btn btn-theme" id="tupianUpload">
									<i class="layui-icon">&#xe67c;</i>上传图片
                                                                                                ...
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">医生人数</label>
							<div class="layui-input-block">
								<input type="text" name="yishengrenshu" id="yishengrenshu" placeholder="医生人数" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">科室简介</label>
							<div class="layui-input-block">
								<input type="text" name="keshijianjie" id="keshijianjie" placeholder="科室简介" autocomplete="off" class="layui-input">
							</div>
						</div>
