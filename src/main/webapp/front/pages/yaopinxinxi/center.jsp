				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="shengchanshang" id="shengchanshang" placeholder="生产商" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="yaopinxiangqing" id="yaopinxiangqing" placeholder="药品详情" autocomplete="off" class="layui-input">
							</div>
						</div>
