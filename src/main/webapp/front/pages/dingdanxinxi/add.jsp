		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.shengchanshang" type="text" name="shengchanshang" id="shengchanshang" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
		...
		<script>
			...
			var vue = new Vue({
                ...
                computed: {
                                                                                                                                                                                                                                                                                                                                                                                                                                    zongjine:{
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                get: function () {
                        return 1*this.detail.shuliang*this.detail.jiage
                    }
                    },
                                                                                                                                                                                                                                                                },
				methods: {
