		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.chongwuming" type="text" name="chongwuming" id="chongwuming" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">宠物状况：</label>
						<div class="layui-input-block">
							<input v-model="detail.chongwuzhuangkuang" type="text" name="chongwuzhuangkuang" id="chongwuzhuangkuang" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">预约日期：</label>
						<div class="layui-input-block">
							<input type="text" name="yuyueriqi" id="yuyueriqi" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.keshimingcheng" type="text" name="keshimingcheng" id="keshimingcheng" autocomplete="off" class="layui-input">
						</div>
					</div>
